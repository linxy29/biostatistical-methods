...
#RMSE=0.2130177,Rsquared=0.8342916 - good % variantion acconted for
...
# Full data had an Rsquared=0.8299; what was the CV result for Rsquared?
# What about MSE values?
